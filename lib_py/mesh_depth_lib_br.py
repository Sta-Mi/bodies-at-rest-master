    ...
    def __init__(self, loss_vector_type, batch_size, verts_list):
        ...
        if verts_list == "all":
            if loss_vector_type == 'anglesR' or loss_vector_type == 'anglesDC' or loss_vector_type == 'anglesEU':
                ...
                model_path_f = '/home/shnh/DATA/zjy/smpl/models/basicModel_f_lbs_10_207_0_v1.0.0.pkl'
                ...
                model_path_m = '/home/shnh/DATA/zjy/smpl/models/basicmodel_m_lbs_10_207_0_v1.0.0.pkl'
